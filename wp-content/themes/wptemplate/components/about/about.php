<section class="component aboutme text-center">	
    <div class="container">
        <div class="aboutme-content">
            <h2>Why Choose me?</h2>
            <p>Industry Leading  Managed Services and Staffing solutions.</p>
        </div>

    <div class="row">
        <div class="aboutme-content_col col-lg-3 col-sm-6">
            <div class="icon-round">
                <svg height="50" width="50" version="1.1" id="Capa_1" x="0px" y="0px"
            ...
            <h3>Modern Design</h3>
            <p>Our team are experts in matching you with right provider.</p>
        </div>
        <div class="aboutme-content_col col-lg-3 col-sm-6">
        <div class="icon-round">
                <svg version="1.1" id="Capa_1" x="0px" y="0px" height="50" width="50"
                    viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                <g>
                    <g>
                        <polygon points="376.822,153.145 281.402,455.309 512,153.145 		"/>
